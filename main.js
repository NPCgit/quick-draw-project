...
drawn = document.getElementById("drawn").innerHTML = "Sketch to be drawn: " + Sketch;
...
function draw()
{
    ...
    if (drawn_sketch == Sketch)
    {
        answer_holder = "set";
        score = score + 1;
        span = document.getElementById("score").innerHTML = "Score:" + score;
    }
}
...
function check_sketch()
{
    ...
    TimeLeft = document.getElementById("TimeLeft").innerHTML = "Time: " + timer_counter;
...
function gotResult(error, results)
{
    ...
    console.log(results);
    document.getElementById('yours').innerHTML = "Your Sketch: " + results[0].label;
